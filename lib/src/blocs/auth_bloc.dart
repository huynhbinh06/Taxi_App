...
class AuthBloc {
  ...
  void signUp(String name, String phone, String email, String pass, Function onSuccess, Function(String) onError) {

    _firAuth.singUp(name, phone, email, pass, onSuccess,onError);
